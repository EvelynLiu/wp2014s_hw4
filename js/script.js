...
//以下為canvas的程式碼，基本上不需多動，依據comments修改即可
	...
	img2.src = "img/wallpaper.jpg" //圖像路徑
	var img3 = new Image();//新增圖像3
	img3.src = "img/textbox.jpg"//圖像路徑
    ...
    function handleMouseMove(e){//滑鼠移動的event
      ...
      if(isDragging){ //當拖拉為True時
			...
			ctx.fillText(inputedText,200,380); //字體也可以依據滑鼠游標移動，所輸入的值可自行調整，若不想移動輸入的字體，可以把它改成（inputedText,0,0)X Y軸 0，0的位置
      }
    }
